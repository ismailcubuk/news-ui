  ...
  return (
    <div className="flex flex-col gap-6 shrink-0 w-full">
        <img src="/images/thumbs/thumb1.jpg" alt="thumb1"/>
          <p className="mymd:text-[42px] mymd:leading-[52px] mytablet:text-[36px] mytablet:leading-[44px] text-[28px] leading-[36px] font-bold">
            Celebrate Kamala Harris, But Don’t Stop Applying Pressure To The
            System
          </p>
          <p className="font-normal text-[16px] leading-[24px] mysm:text-[18px] mysm:leading-[28px]">
